...
import {TabPanel} from '../buildercontrols/AppBuilderVerticalTabContent';
  ...
  return (
    <div
      ...
      <svg
        ...
        width={isLivePreview ? '1394' : ''}
        height={isLivePreview ? 'calc(100vh - 60px)' : ''}
        ...
        <defs>
          ...
          <pattern
            ...
            height="100%"
            viewBox="0 0 300 103">
            <image width="300" height="103" xlinkHref={primaryLogoUrl} />
          </pattern>
        </defs>
        <g
          id="Group_501"
          ...
          <g id="Group_500" data-name="Group 500">
            ...
            <text
              id="Where_business_happens_online_on_time_each_time."
            ...
            <g
              id="Group_494"
              data-name="Group 494"
              transform="translate(434 478.61)">
              <rect
                id="Rectangle_279"
            ...
            <g
              ...
              <text
                id="Use_PSTN_Join_by_dialing_a_number_"
              ...
              <g id="Group_491" data-name="Group 491">
                <text
                  id="Restrict_Host_Controls_Separate_host_link_"
            ...
            <path
              id="Path_581"
              data-name="Path 581"
              d="M50.5,42.363c0-3.791,3.834-6.863,8.563-6.863H1177.937c4.727,0,8.563,3.073,8.563,6.863V63.971H50.5Z"
            ...
            <circle
              ...
              cy="5.556"
              r="5.556"
              transform="translate(106.333 50)"
              fill="#c4c4c4"
            />
            <g
              id="Group_495"
              data-name="Group 495"
              transform="translate(434 336.776)">
              <g
                id="Component_2_7"
...
const LivePreviewContentMobile = () => {
  ...
  const primary_font_color = productInfo.primary_font_color;
  const landing_sub_heading = productInfo.landing_sub_heading;
  const primary_color = productInfo.primary_color;
              ...
              __html: `<svg style="z-index: -1;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="629" height="calc(100vh - 60px)" viewBox="0 0 629 950">
                              <defs>
                                ...
                                <pattern id="pattern" preserveAspectRatio="none" width="100%" height="100%" viewBox="0 0 1136 730">
                                  <image width="1136" height="730" xlink:href="${backgroundLogoUrl}"/>
                                </pattern>
                              ...
                              <g id="SVG_4" data-name="SVG – 4" clip-path="url(#clip-SVG_4)">
                                ...
                                <g id="Group_498" data-name="Group 498" transform="translate(-253.816 69.858)">
                                  ...
                                  <g id="Group_499" data-name="Group 499" transform="translate(-6)">
                                    ...
                                    <text id="Together_Business" data-name="Together Business" transform="translate(570 255)" fill=${primary_font_color} font-size="23" font-family="Roboto-Bold, Roboto" font-weight="700" dominant-baseline="middle" text-anchor="middle">${product_name}</text>
                                    <foreignObject width="280" height="200" style="transform: translate(433px, 254px)"
                                      requiredFeatures="http://www.w3.org/TR/SVG11/feature#Extensibility">
                                        <p style="text-align: center;font-size: 14px;line-height: 14px; margin-top:17px; color: ${primary_font_color}" xmlns="http://www.w3.org/1999/xhtml">${landing_sub_heading}</p>
                                    </foreignObject>
                                    <g id="Group_494" data-name="Group 494" transform="translate(430.686 432)">
                                      <rect id="Rectangle_279" data-name="Rectangle 279" width="287" height="35" rx="17.5" transform="translate(0.314 0)" fill="${primary_color}"/>
                                    ...
                                    <g id="Group_493" data-name="Group 493" transform="translate(430.686 527)">
                                      <g id="Rectangle_280" fill-opacity="0" data-name="Rectangle 280" transform="translate(0.314 0)" stroke="${primary_color}" stroke-width="0.5">
                                        <rect width="287" height="35" rx="17.5" stroke="none"/>
                                        <rect x="0.25" y="0.25" width="286.5" height="34.5" rx="17.25" fill="none"/>
                                      </g>
                                      <text id="Meeting_ID_or_URL" data-name="Meeting ID or URL" transform="translate(138.314 22)" fill="${primary_color}" font-size="12" font-family="Roboto-Medium, Roboto" font-weight="500"><tspan x="-48.48" y="0">Meeting ID or URL</tspan></text>
                                    </g>
                                    <g id="Group_492" data-name="Group 492" transform="translate(479.538 373)">
                                      <text id="Use_PSTN_Join_by_dialing_a_number_" data-name="Use PSTN (Join by dialing a number)" transform="translate(21.462 33)" fill=${primary_font_color} font-size="9" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">Use PSTN (Join by dialing a number)</tspan></text>
                                      <g id="Group_491" data-name="Group 491" transform="translate(0)">
                                        <text id="Restrict_Host_Controls_Separate_host_link_" data-name="Restrict Host Controls (Separate host link)" transform="translate(21.462 9)" fill=${primary_font_color} font-size="9" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">Restrict Host Controls (Separate host link)</tspan></text>
                                    ...
                                    <g id="Group_495" data-name="Group 495" transform="translate(430.686 318)">
                                      <g id="Component_2_5" fill-opacity="0" data-name="Component 2 – 5" transform="translate(0.314 0)">
                                        <g id="Rectangle_278" data-name="Rectangle 278" transform="translate(0 0)" stroke=${primary_color} stroke-width="0.5">
                                          <rect width="288" height="36" rx="18" stroke="none"/>
                                          <rect x="0.25" y="0.25" width="287.5" height="35.5" rx="17.75" fill="none"/>
                                          </g></g>
                                          <text id="Create_Meeting" data-name="Create Meeting" transform="translate(141.314 20)" fill=${primary_font_color} font-size="12" font-family="Roboto-Medium, Roboto" font-weight="500" dominant-baseline="middle" text-anchor="middle">ACME Meeting</text>
                            `,
            }}
          />
        </TabPanel>
